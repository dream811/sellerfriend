                ...
                foreach ($productItems as $key3 => $item) 
                {
                    ...
                    foreach ($cateMetaInfo->data['attributes'] as $key =>$value) {
                        if($cateMetaInfo->data['attributes'][$key]['required'] == "MANDATORY"){
                            $attributeValueName = "";
                            if($arrOptMapping[$cateMetaInfo->data['attributes'][$key]['attributeTypeName']] == "패션의류/잡화 사이즈")
                                $attributeValueName = $item->strSubItemKrSize;
                            if($arrOptMapping[$cateMetaInfo->data['attributes'][$key]['attributeTypeName']] == "색상")
                    ...
                    $arrItems[] = array(
                        ...
                        "unitCount"=> $item->nSubItemQuantity,
