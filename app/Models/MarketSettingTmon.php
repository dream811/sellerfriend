...
class MarketSettingCoupang extends Model
{
    ...
    protected $fillable = ['nMarketIdx', 'nUserId', 'nMarketAccIdx', 'strTitle', 'nSupportOption', 'nVersion', 'nTopImageIdx', 'nDownImageIdx','strSelMnbdNckNm',
                        'strSelMthdCd',
                        'strPrdTypCd',
                        'strForAbrdBuyClf',
                        'strPrdStatCd',
                        ...
                        'strHopeShpYn',
                        'nHopeShpMinPrice',
                        'created_at', 'updated_at', 'bIsUsed', 'bIsDel'
                        ];
