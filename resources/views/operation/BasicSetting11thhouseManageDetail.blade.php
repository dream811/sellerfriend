                                    ...
                                    <div class="col-sm-9 col-md-9">
                                        <table class="tableForm">
                                            ...
                                            <tbody><tr>
                                                ...
                                                <th style="width:200px;padding:5px 0 !important;text-align:center;">기준(구매금액:판매가+옶션가+추가구성상품금액)</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>이 상품<input type="text" name="mpbsePrdFrDlvBasiAmt" value="" class="cntNum">원 이상<br>구매시 무료</td>
                                                <td>불가</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="vertical-align:top;">
                                                    ...
                                                    <span class="txtRed">~개 이상일때는 빈칸으로<br>두시면 자동입력 됩니다.</span>
                                                </td>
                                                <td>
