    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 text-sm">
                    <form id="manageMarketAccount" method="post" action="{{ route('operation.BasicSettingManageSettingSave') }}"> 
                        @csrf
                        ...
                        <div class="card card-primary" style="margin-bottom:0px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mt-1 mb-0">
                                    ...
                                    <div class="col-sm-9 col-md-6">
                                        <div style="display:inline-block">
                                            <input type="number" class="form-control form-control-sm float-right" id="txtUnityQuantity" name="txtUnityQuantity" value="{{ $marketSetting->nUnitQuantity }}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9 col-md-10">
                                        <div style="display:inline-block">
                                            <input type="text" class="form-control form-control-sm float-right" name="txtMaxQtyPerManDayLimit" id="txtMaxQtyPerManDayLimit" value="{{ $marketSetting->nMaxQtyPerManDayLimit }}">
                                        </div>
                                        <div style="display:inline-block">
                                            일
                                        </div>
                                        <div style="display:inline-block">
                                            <input type="text" class="form-control form-control-sm float-right" name="txtMaxQtyPerManQtyLimit" id="txtMaxQtyPerManQtyLimit" value="{{ $marketSetting->nMaxQtyPerManQtyLimit }}">
                                        </div>
                                        <div style="display:inline-block">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9 col-md-6 mt-1">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" id="rdoOverSeaPurchaseAgentY" name="rdoOverSeaPurchaseAgent" @if( $marketSetting->bOverSeaPurchaseAgent == 1 ) checked @endif>
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">예</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" id="rdoOverSeaPurchaseAgentN" name="rdoOverSeaPurchaseAgent" @if( $marketSetting->bOverSeaPurchaseAgent == 0 ) checked @endif>
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">아니</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9 col-md-6 mt-1">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" id="rdoOnlyAdultY" name="rdordoOnlyAdult" @if( $marketSetting->bOnlyAdult == 0 ) checked @endif value="1">
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">가능</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" id="rdoOnlyAdultN" name="rdordoOnlyAdult" @if( $marketSetting->bOnlyAdult == 0 ) checked @endif value="0">
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">불가능</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9 col-md-10 mt-1">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">에러처리</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" id="rdoImageProcessType1" name="rdoImageProcessType" value="1"  @if( $marketSetting->nImageProcessType == 1 ) checked @endif>
                                            <label for="customRadio1" class="custom-control-label pt-1" style="font-size:12px;">500 x 500으로 자동등록</label>
