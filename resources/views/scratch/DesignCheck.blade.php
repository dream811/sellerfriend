...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0" style="">디자인검토</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">HOME</a></li>
                <li class="breadcrumb-item"><a href="#">상품수집관리</a></li>
                <li class="breadcrumb-item active">디자인검토</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#productTable').on('click', '.btnSellTargetProduct', function (e) {
                var id = $(this).attr('data-id');
                var action = '/scratchDesignCheck/' + id;// $("#manageMarketAccount").attr("action");
                $.ajax({
                    url: action,
                    type: "PUT",
                    dataType: 'json',
